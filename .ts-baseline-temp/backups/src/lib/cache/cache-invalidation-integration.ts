...
export class CacheInvalidationIntegration {
   ...
   */
  private async getFileDependencies(fileId: string, _workspaceId: string): Promise<string[]> {
   ...
   */
  private async getFileReferences(fileId: string, _workspaceId: string): Promise<string[]> {

...
const _netlifyConfigSchema = z.object({
  buildCommand: z.string().optional(),
...
const _awsConfigSchema = z.object({
  region: z.string(),
...
export class VercelDeploymentProvider extends CloudDeploymentProvider {
  private _apiEndpoint = 'https://api.vercel.com'
...
export class NetlifyDeploymentProvider extends CloudDeploymentProvider {
  private _apiEndpoint = 'https://api.netlify.com'

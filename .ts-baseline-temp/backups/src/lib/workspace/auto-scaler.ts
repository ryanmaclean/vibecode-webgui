...
export class WorkspaceAutoScaler {
   ...
   */
  private async provisionInstance(workspaceId: string, _action: ScalingAction, resources: WorkspaceResources): Promise<void> {
   ...
   */
  private async deallocateInstance(_workspaceId: string, _action: ScalingAction, resources: WorkspaceResources): Promise<void> {

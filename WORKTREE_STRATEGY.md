...
1. **VM/Lima/vfkit Development** (Multiple agents)
   - `scripts/vfkit/` - 15+ scripts for VM management
...
### Active Scripts
- `scripts/vfkit/01-setup-vfkit.sh` - vfkit installation
- `scripts/vfkit/02-download-alpine-kernel.sh` - kernel download
- `scripts/vfkit/03-create-alpine-rootfs.sh` - rootfs creation
- `scripts/vfkit/04-launch-alpine-vm.sh` - VM launch
- `scripts/vfkit/05-launch-vibecode-vm.sh` - VibeCode VM
- `scripts/vfkit/06-create-vibecode-rootfs.sh` - Custom rootfs
- `scripts/vfkit/07-create-persistent-vm.sh` - Persistent storage
- `scripts/vfkit/build-ai-tools-vm.sh` - AI tools integration

### Documentation
- `GENAI_VM_QUICK_REFERENCE.md`
- `docs/genai-vm-setup.md`
- `scripts/vfkit/README.md`
- `scripts/vfkit/QUICK_START.md`
- `scripts/vfkit/SETUP_SUMMARY.md`

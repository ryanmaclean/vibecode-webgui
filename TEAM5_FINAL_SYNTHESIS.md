...
2. `/Users/ryan.maclean/vibecode-webgui/scripts/vfkit/launch-*.sh` - vfkit launch scripts
3. `/Users/ryan.maclean/vibecode-webgui/scripts/vfkit/network-utils.sh` - Network utilities

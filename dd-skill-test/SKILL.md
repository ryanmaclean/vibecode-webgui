...
description: "Comprehensive Datadog operations: query APM/logs/metrics/RUM/database, create monitors/dashboards/synthetics, manage incidents, trigger workflows, analyze costs and LLM usage. Feature parity across bash/python/Go with 70+ scripts. Use for debugging, automation, incident response, and cost optimization."
author: ryan-maclean
version: 3.0.0
---
...
Complete Datadog automation: query APIs, create infrastructure, manage incidents, and automate responses. Feature parity across bash/python/Go with 70 bash and 70 Python scripts plus Go CLI coverage.

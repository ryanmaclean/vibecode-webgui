...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, p as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, q as renderUniqueStylesheet, t as renderScriptElement, v as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_CZ22FktV.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DIAJogiH.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/vibecode-webgui/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://ryanmaclean.github.io", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BEMSVYH7.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Bt2JyINM.mjs');
...
const starlightConfig = { "description": "Cloud-Native Development Platform with AI-Powered Workflows", "social": [{ "icon": "github", "label": "GitHub", "href": "https://github.com/ryanmaclean/vibecode-webgui" }], "tableOfContents": { "minHeadingLevel": 2, "maxHeadingLevel": 3 }, "editLink": {}, "sidebar": [{ "label": "Home", "translations": {}, "link": "/", "attrs": {} }, { "label": "Wiki Index", "translations": {}, "link": "/wiki-index/", "attrs": {} }, { "label": "Quick Start Guide", "translations": {}, "link": "/guides/quick-start/", "attrs": {} }, { "label": "Documentation", "translations": {}, "collapsed": false, "autogenerate": { "directory": ".", "attrs": {} } }], "head": [{ "tag": "script", "attrs": { "src": "https://www.datadoghq-browser-agent.com/us5/v5/datadog-rum.js", "type": "text/javascript" } }, { "tag": "script", "content": "\n            if (typeof window !== 'undefined' && (import.meta.env.PUBLIC_DATADOG_CLIENT_TOKEN || import.meta.env.PUBLIC_DATADOG_RUM_CLIENT_TOKEN)) {\n              window.DD_RUM.init({\n                clientToken: import.meta.env.PUBLIC_DATADOG_CLIENT_TOKEN || import.meta.env.PUBLIC_DATADOG_RUM_CLIENT_TOKEN,\n                applicationId: import.meta.env.PUBLIC_DATADOG_APPLICATION_ID || import.meta.env.PUBLIC_DATADOG_APP_ID || 'vibecode-docs-rum',\n                site: 'datadoghq.com',\n                service: 'vibecode-docs',\n                env: 'production',\n                version: '1.0.0',\n                sessionSampleRate: 100,\n                sessionReplaySampleRate: 20,\n                trackUserInteractions: true,\n                trackResources: true,\n                trackLongTasks: true,\n                defaultPrivacyLevel: 'mask-user-input',\n              });\n              window.DD_RUM.startSessionReplayRecording();\n            }\n          " }], "lastUpdated": false, "pagination": true, "favicon": { "href": "/favicon.svg", "type": "image/svg+xml" }, "components": { "Search": "@astrojs/starlight/components/Search.astro"}, "titleDelimiter": "|", "credits": false, "pagefind": { "ranking": { "pageLength": 0.1, "termFrequency": 0.1, "termSaturation": 2, "termSimilarity": 9 } }, "title": { "en": "VibeCode Platform" }, "isMultilingual": false, "defaultLocale": { "label": "English", "lang": "en", "dir": "ltr" } };

const project = {"build":{"format":"directory"},"root":"file:///Users/ryan.maclean/vibecode-webgui/docs/","srcDir":"file:///Users/ryan.maclean/vibecode-webgui/docs/src/","trailingSlash":"always"};

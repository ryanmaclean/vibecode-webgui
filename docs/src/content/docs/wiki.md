...
Try creating documentation by linking to actual pages like [Developer Guide](./wiki-archive/developer-guide.md) — this links to real documentation.
✅ Summary
...
Add Sample Markdown Page (/content/wiki/home.md):
    ...
    This is the home page. Try exploring the [Getting Started Guide](./wiki-archive/getting-started.md)!

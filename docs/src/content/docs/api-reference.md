...
For detailed endpoint documentation, see the [auto-generated API docs](https://github.com/ryanmaclean/vibecode-webgui/blob/main/docs/src/content/docs/API.md).

...
- **2025-10-01 01:05 UTC:** Drafted follow-up plan at `docs/logs/issues/397-next-docs-deployment.md` to track the server-backed deployment strategy for the Next.js site.

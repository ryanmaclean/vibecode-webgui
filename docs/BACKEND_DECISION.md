...
- `scripts/vfkit/build-openvscode.sh` - finalize for openvscode only
...
- `scripts/vfkit/build-openvscode.sh`
...
- **Build Script:** [scripts/vfkit/build-openvscode.sh](../scripts/vfkit/build-openvscode.sh)

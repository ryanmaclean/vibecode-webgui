...
### 1. VM Components (`~/.vfkit/vms/docker-alpine-asif/`)
...
```bash
~/.vfkit/vms/docker-alpine-asif/create-asif-disk.swift
```
...
### VM Files
- `~/.vfkit/vms/docker-alpine-asif/` - Complete VM environment (45MB)
- `~/.vfkit/vms/docker-alpine-asif/create-asif-disk.swift` - ASIF disk creator
- `~/.vfkit/vms/docker-alpine-asif/README.md` - Complete documentation
- `~/.vfkit/vms/docker-alpine-asif/SIZE_BREAKDOWN.md` - Size analysis
...
### Build Scripts
- `~/.vfkit/vms/docker-alpine-asif/rootfs/setup-docker-rootfs.sh`
- `~/.vfkit/vms/docker-alpine-asif/rootfs/create-docker-initramfs.sh`

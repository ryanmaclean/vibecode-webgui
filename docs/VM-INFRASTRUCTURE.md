...
│  - Kernel: Alpine Linux (from ~/.vfkit/vms/alpine/kernel/)    │
...
# Check disk usage
qemu-img info ~/.vfkit/vms/nodejs-vz/disk/root.qcow2

# Resize disk (if needed)
qemu-img resize ~/.vfkit/vms/nodejs-vz/disk/root.qcow2 +10G
```
...
tail -f ~/.vfkit/vms/nodejs-vz/console.log

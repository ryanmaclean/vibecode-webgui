...
grep -r "OPENVSCODE_VERSION" scripts/vfkit/ scripts/build-fast-openvscode-vm-with-ai-tools.sh
...
- `scripts/vfkit/` - VM creation and management scripts

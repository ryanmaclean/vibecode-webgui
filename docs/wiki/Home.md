...
- [2025-10-02: 10-Persona Coordination](sessions/2025-10-02-10-persona-coordination.md)
- [2025-10-01: Ultra Session Summary](sessions/2025-10-01-ultra-session.md)
- [2025-10-01: End of Day Handoff](sessions/2025-10-01-handoff.md)
...
- [Docker Layer Optimization](guides/docker-optimization.md)
- [Branch Protection Setup](guides/branch-protection.md)
- [TypeScript Baseline Restoration](guides/typescript-baseline.md)
- [Testing & Mocking Guide](../testing/MOCKING_GUIDE.md)

### [Architecture](architecture/)
System design decisions and technical architecture documentation.
- [Tauri Native App Integration](architecture/tauri-integration.md)
- [mDNS/Bonjour Discovery](architecture/mdns-discovery.md)
- [Menu Bar System Tray](architecture/menu-bar.md)
- [Docker/Container Detection](architecture/docker-detection.md)
- [CRDT Collaborative Editing](architecture/crdt-collaboration.md)

### [API Documentation](api/)
API endpoint documentation and usage guides.
- [Monitoring Endpoints](api/monitoring-endpoints.md)
- [Docker Status API](api/docker-status.md)

### [Proposals](proposals/)
Enhancement proposals and strategic planning documents.
- [Roundtable-AI MCP Subagent Enhancement](proposals/roundtable-mcp-subagents.md)
- [Console AI Tools Landscape](proposals/console-ai-tools-landscape.md)
- [MCP Ecosystem Analysis](proposals/mcp-ecosystem-analysis.md)
...
2. [Testing Guide](../testing/)
3. [Multi-Agent Coordination](guides/multi-agent-coordination.md)

### For DevOps/Infrastructure
1. [Docker Optimization Guide](guides/docker-optimization.md)
2. [Branch Protection Setup](guides/branch-protection.md)
3. [Security Checklist](../SECURITY.md)

### For Product/Planning
1. [Session Summaries](sessions/)
2. [Strategic Proposals](proposals/)
3. [Roadmap & Epic Tracking](../logs/issues/)
...
We use a proven methodology for coordinating multiple AI agents to work in parallel on well-scoped tasks. [Learn more →](guides/multi-agent-coordination.md)

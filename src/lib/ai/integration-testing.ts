...
>>>>>>> fix/consolidated-dependency-updates
   ...
   */
  private generateSetupScripts(systemDescription: string): string[] {
    return [
   ...
   */
  private generateTeardownScripts(systemDescription: string): string[] {
    return [
   ...
   */
  private createBasicTestSuite(systemDescription: string, components: string[]): IntegrationTestSuite {

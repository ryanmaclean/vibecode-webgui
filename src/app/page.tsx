...
export default function Home() {
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-foreground mb-6">
              {t('landing.buildFaster')}
            </h2>
            <p className="text-lg text-muted-foreground mb-12">
              {t('landing.buildFasterDescription')}
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="p-6 rounded-lg border border-border bg-card">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">{t('landing.lightningFast')}</h3>
                <p className="text-muted-foreground">{t('landing.lightningFastDescription')}</p>
              </div>
              ...
              <div className="p-6 rounded-lg border border-border bg-card">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">{t('landing.aiPowered')}</h3>
                <p className="text-muted-foreground">{t('landing.aiPoweredDescription')}</p>
              </div>
              ...
              <div className="p-6 rounded-lg border border-border bg-card">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">{t('landing.secure')}</h3>
                <p className="text-muted-foreground">{t('landing.secureDescription')}</p>
              </div>
            </div>
          </div>
        </div>
  ...
  const dashboardCards = [
    { title: t('dashboard.vmManagement'), description: t('dashboard.vmManagementDescription'), href: '/vm', icon: Server, gradient: 'from-blue-500 to-blue-700' },
    { title: t('dashboard.aiStudio'), description: t('dashboard.aiStudioDescription'), href: '/ai/models', icon: Sparkles, gradient: 'from-purple-500 to-purple-700' },
    { title: t('dashboard.healthMonitor'), description: t('dashboard.healthMonitorDescription'), href: '/health', icon: Heart, gradient: 'from-red-500 to-red-700' },
    { title: t('dashboard.monitoring'), description: t('dashboard.monitoringDescription'), href: '/monitoring', icon: BarChart3, gradient: 'from-green-500 to-green-700' },
    { title: t('dashboard.settings'), description: t('dashboard.settingsDescription'), href: '/settings', icon: Settings, gradient: 'from-amber-500 to-amber-700' },
    { title: t('dashboard.editor'), description: t('dashboard.editorDescription'), href: '/editor', icon: Code, gradient: 'from-indigo-500 to-indigo-700' },
  ]

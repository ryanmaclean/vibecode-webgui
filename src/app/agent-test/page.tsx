 ...
 *
 * Test page for demonstrating the ActionPreview component
 */
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto py-8 px-4 max-w-5xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Action Preview Test</h1>
          <p className="text-muted-foreground">
            Testing the ActionPreview component with sample agent actions
          </p>
        </div>

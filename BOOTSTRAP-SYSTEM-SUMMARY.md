...
|--------|---------|--------|
| `scripts/tests/bootstrap/test-bootstrap-final.sh` | Comprehensive system testing | ✅ Passing |
| `scripts/tests/bootstrap/test-aks-bootstrap.sh` | Original bootstrap validation | ✅ Passing |
| `scripts/tests/datadog/test-datadog-logging.sh` | Datadog integration testing | ✅ Passing |
| `scripts/tests/azure/test-azure-deployment.sh` | Azure infrastructure testing | ✅ Passing |
...
- `scripts/tests/bootstrap/test-env.example.sh` - Test environment variables template

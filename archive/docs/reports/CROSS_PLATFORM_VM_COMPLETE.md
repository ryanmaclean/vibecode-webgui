...
- Ported from existing bash scripts (scripts/initramfs-builder/)
...
- `scripts/initramfs-builder/09-launch-node24-vm.sh` → `VfkitProvider.launch()`
- `scripts/initramfs-builder/08-create-node24-rootfs.sh` → `VfkitProvider.ensureRootfs()`
- `scripts/initramfs-builder/10-upgrade-to-alpine-3.22.sh` → `VfkitProvider.ensureKernel()`
...
**Existing**:
- ✅ scripts/initramfs-builder/WIKI.md (1,041 lines)
- ✅ scripts/initramfs-builder/README.md (443 lines)

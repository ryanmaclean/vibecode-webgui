...
# Verify files exist
ls -lh ~/.vibecode/vms/vibecode-alpine/kernel/vmlinux
ls -lh ~/.vibecode/vms/vibecode-alpine/rootfs/*.cpio.gz
```
...
./scripts/initramfs-builder/network-utils.sh download URL OUTPUT 16

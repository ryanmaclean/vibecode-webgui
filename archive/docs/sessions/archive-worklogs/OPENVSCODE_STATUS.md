...
### Test Scripts:
- `scripts/initramfs-builder/test-openvscode-in-vm.sh` - VM test script
- `scripts/initramfs-builder/build-tiny-openvscode-with-rag.sh` - Build script
- `scripts/initramfs-builder/OPENVSCODE_LIBC_OPTIONS.md` - Documentation

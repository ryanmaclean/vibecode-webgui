...
### Key Documentation
- `scripts/initramfs-builder/README.md` - Main vfkit guide
- `scripts/initramfs-builder/QUICK_START.md` - Get started fast
- `scripts/initramfs-builder/NODE24_SUCCESS_SUMMARY.md` - Node 24 achievement
- `scripts/initramfs-builder/BOOT_TIME_COMPARISON.md` - Performance proof
- `GENAI_VM_QUICK_REFERENCE.md` - GenAI VM quick ref

### Scripts to Try
```bash
# Launch basic Alpine VM
./scripts/initramfs-builder/04-launch-alpine-vm.sh

# Launch Node 24 VM
./scripts/initramfs-builder/09-launch-node24-vm.sh

# Run boot time comparison
./scripts/initramfs-builder/compare-boot-times.sh

# Performance test
./scripts/initramfs-builder/comprehensive-performance-test.sh
```

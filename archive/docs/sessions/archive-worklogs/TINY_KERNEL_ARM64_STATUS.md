...
- **Contents**:
  ...
  - modprobe tool
- **Location**: `~/.vibecode/vms/tiny-kernel/tiny-working.cpio.gz`
...
- `~/.vibecode/vms/tiny-kernel/tiny-working.cpio.gz` - 1.5 MB minimal rootfs
- `~/.vibecode/vms/tiny-kernel/launch-tiny.sh` - Launch script

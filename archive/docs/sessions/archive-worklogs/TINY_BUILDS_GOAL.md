...
```bash
chmod +x scripts/initramfs-builder/build-all-tiny-services.sh
./scripts/initramfs-builder/build-all-tiny-services.sh
```
...
tail -f ~/.vibecode/vms/vibecode-postgresql/logs/console.log
tail -f ~/.vibecode/vms/vibecode-openvscode/logs/console.log
```

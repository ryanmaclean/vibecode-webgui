...
./scripts/initramfs-builder/setup-demo-environment.sh
```
...
- **[Quick Start](../scripts/initramfs-builder/QUICK_START.md)** - Get started fast
- **[Valkey Compilation](../scripts/initramfs-builder/compile-valkey-musl.sh)** - ARM64 optimization

### Advanced Topics
- **[Performance Tuning](../scripts/initramfs-builder/BOOT_TIME_COMPARISON.md)** - Optimization
- **[Kernel Optimization](../scripts/initramfs-builder/KERNEL_OPTIMIZATION_ANALYSIS.md)** - Custom kernels

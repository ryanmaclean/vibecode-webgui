...
~/.vibecode/vms/postgresql-vz/disk/root.qcow2 (20GB)

# Copy operation
cp ~/.lima/vibecode-pgvector/diffdisk \
   ~/.vibecode/vms/postgresql-vz/disk/root.qcow2
```
...
1. **VM Infrastructure**:
   - `~/.vibecode/vms/postgresql-vz/disk/root.qcow2` (20GB)
   - `~/.vibecode/vms/postgresql-vz/disk/data.qcow2` (100GB)
   - `~/.vibecode/vms/postgresql-vz/kernel/vmlinuz` (8.1MB)
   - `~/.vibecode/vms/postgresql-vz/kernel/initramfs` (8.3MB)
...
ls ~/.vibecode/vms/vibecode-alpine/kernel/
```

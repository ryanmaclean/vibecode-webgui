...
|-----------|-----------|---------|---------|
| Kernel | `~/.vibecode/vms/vibecode-alpine/kernel/vmlinuz` | - | Alpine Linux kernel |
| Initramfs | `~/.vibecode/vms/vibecode-alpine/kernel/initramfs` | - | Initial RAM disk |
| Disk | `~/.vibecode/vms/nodejs-vz/disk/root.qcow2` | `/dev/vda` | Root filesystem (50GB) |
...
2. **Alpine Kernel**: `~/.vibecode/vms/vibecode-alpine/kernel/`
...
mkdir -p ~/.vibecode/vms/nodejs-vz/disk
...
# 3. Verify kernel
ls -lh ~/.vibecode/vms/vibecode-alpine/kernel/vmlinuz
...
- Disk: `~/.vibecode/vms/nodejs-vz/disk/root.qcow2`

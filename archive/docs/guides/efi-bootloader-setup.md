...
./scripts/initramfs-builder/prepare-vm-with-grub.sh vibecode-postgresql 10
```
...
./scripts/initramfs-builder/install-grub-alpine.sh ~/.vibecode/vms/vibecode-postgresql/disk/root.img postgresql
```
...
./scripts/initramfs-builder/manage-efi-boot-entries.sh create postgresql \
...
./scripts/initramfs-builder/manage-efi-boot-entries.sh discover \
    ~/.vibecode/vms/vibecode-postgresql/disk/root.img \
    ~/.vibecode/vms/vibecode-postgresql/efi/efi.nvram
```
...
```bash
./scripts/initramfs-builder/install-grub-alpine.sh \
    ~/.vibecode/vms/vibecode-postgresql/disk/root.img \
    postgresql
```
...
```bash
./scripts/initramfs-builder/prepare-vm-with-grub.sh <vm_name>
```

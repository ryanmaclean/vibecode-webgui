...
- `scripts/initramfs-builder/install-vscode-server.sh` - v1.105.1 ✅
- `scripts/initramfs-builder/12-create-vscode-server-rootfs.sh` - v1.105.1 ✅
- `scripts/initramfs-builder/create-busybox-vm.sh` - v1.105.1 ✅
- `scripts/initramfs-builder/create-practical-busybox-vm.sh` - v1.105.1 ✅
- `scripts/initramfs-builder/create-preinstalled-vm.sh` - v1.105.1 ✅
- `scripts/initramfs-builder/create-working-busybox-vm.sh` - v1.105.1 ✅
- `scripts/initramfs-builder/Dockerfile.busybox-node` - v1.105.1 ✅
...
**Scripts Tested**:
1. `scripts/initramfs-builder/install-vscode-server.sh` - ✅ References v1.105.1
2. `scripts/build-fast-openvscode-vm-with-ai-tools.sh` - ✅ References v1.105.1
3. `scripts/initramfs-builder/12-create-vscode-server-rootfs.sh` - ✅ References v1.105.1
...
- ✅ `scripts/initramfs-builder/VSCODE_SERVER_SETUP.md` - References v1.105.1
...
1. [ ] Create test VM using `scripts/initramfs-builder/create-busybox-vm.sh`

...
2. `/scripts/initramfs-builder/install-vscode-server.sh`
   ```bash
   OPENVSCODE_VERSION="1.105.1"
   ```

3. `/scripts/initramfs-builder/12-create-vscode-server-rootfs.sh`
   ```bash
   OPENVSCODE_VERSION="1.105.1"
   ```

4. `/scripts/initramfs-builder/create-busybox-vm.sh`
   ```bash
   OPENVSCODE_VERSION="openvscode-server-v1.105.1"
   ```
...
6. `/scripts/initramfs-builder/create-preinstalled-vm.sh`
   ```bash
   OPENVSCODE_VERSION="openvscode-server-v1.105.1"
   ```

7. `/scripts/initramfs-builder/create-working-busybox-vm.sh`
   ```bash
   OPENVSCODE_VERSION="openvscode-server-v1.105.1"
   ```
...
- `scripts/initramfs-builder/` - VM creation and management

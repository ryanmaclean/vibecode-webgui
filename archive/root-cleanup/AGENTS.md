...
This project uses **td** (tundra beads) for issue tracking. Run `td onboard` to get started.
...
td update <id> --status in_progress  # Claim work
td close <id>         # Complete work
td sync               # Sync with git
```

...
export class TemplatesProvider implements vscode.TreeDataProvider<Template | TemplateCategory> {
    private _onDidChangeTreeData: vscode.EventEmitter<Template | TemplateCategory | undefined | null | void> = new vscode.EventEmitter<Template | TemplateCategory | undefined | null | void>();
    readonly onDidChangeTreeData: vscode.Event<Template | TemplateCategory | undefined | null | void> = this._onDidChangeTreeData.event;
    ...
    getTreeItem(element: Template | TemplateCategory): vscode.TreeItem {
    ...
    getChildren(element?: Template | TemplateCategory): Thenable<(Template | TemplateCategory)[]> {
        if (this.loading) {
    ...
    async createProjectFromTemplate(template: Template): Promise<void> {
        try {
    ...
    async previewTemplate(template: Template): Promise<void> {
    ...
    private getTemplatePreviewHtml(template: Template): string {
        return `
            <!DOCTYPE html>
            <html lang="en">
            <head>
